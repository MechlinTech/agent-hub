...
export function LocalExecutorInstructions({
  ...
  return (
    <div className="space-y-4 text-sm text-slate-600">
      <p>
        {isSettings
          ? "Dev Scaffold runs on your PC through AgentHub Desktop - not on the AgentHub server. Desktop must be on the same machine as this browser."
          : "Dev Scaffold scaffolds projects locally via AgentHub Desktop. Pair once, then run setups from the wizard."}
      </p>
      ...
      <InstructionSection title="First-time pairing">
        {isSettings ? (
          <>
            <li>
              Start <strong>AgentHub Desktop</strong> on this PC (download below
          ...
          <>
            <li>
              Download and start <strong>AgentHub Desktop</strong> on the same
              PC you use in the browser.
            </li>
            <li>
              Open <strong>Settings → Local Executor</strong> (or use the Local
              Executor card above).
            </li>
            <li>
            ...
            <li>
              Click <strong>Pair executor</strong>. Once connected, you are
              ready to run Dev Scaffold.
            </li>
          </>
        )}
      </InstructionSection>
      ...
      <InstructionSection title="Every setup after that">
        ...
        <li>
          In the desktop app, click <strong>Open AgentHub to connect</strong> to
          open the browser.
        </li>
        <li>In the wizard, choose your scope, stack, and target folder.</li>
        <li>
